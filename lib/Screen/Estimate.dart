...
import 'package:eshop_multivendor/Model/estimate_list_model.dart';
...
class StateEstimate extends State<Estimate> with TickerProviderStateMixin {
                              ...
                              Hero(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: FadeInImage(
                                      ...
                                      image: CachedNetworkImageProvider(items[index].sellerEstimate.toString()),
                                      height: 100.0,
                                      width: 100.0,
                                      fit: BoxFit.cover,
      ...
      try {
        if (isLoadingmore) {
          ...
          if (CUR_USERID != null) {
            ...
            // }
            Response response =
            await post(estimateListApi, body: parameter, headers: headers)
                .timeout(Duration(seconds: timeOut));
            print(getOrderApi.toString());
            print(parameter.toString());
            var getdata = json.decode(response.body);
            print(estimateListApi.toString());
            print(parameter.toString());
            ...
            if (!error) {
              ...
              if (data.length != 0) {
                ...
                for (Data item in items) {
                  searchList.where((i) => i.id == item.userId).map((obj) {
