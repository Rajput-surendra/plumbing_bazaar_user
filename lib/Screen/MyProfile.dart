...
import 'package:eshop_multivendor/Screen/Estimate.dart';
  ...
  _getDrawer() {
    return ListView(
      ...
      children: <Widget>[
        ...
        _getDrawerItem(getTranslated(context, 'Upload_Estimate')!,
    ...
    return Card(
      ...
      child: ListTile(
        ...
        onTap: () {
          ...
          else if (title == getTranslated(context, 'Upload_Estimate')) {
            Navigator.push(
                context,
                MaterialPageRoute(
