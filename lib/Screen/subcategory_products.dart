...
class SubCatProducts extends StatefulWidget {
  ...
  String catId;
  SubCatProducts({
    required this.image, required this.catId, Key? key}) : super(key: key);
...
class _SubCatProductsState extends State<SubCatProducts> {
  ...
  Widget build(BuildContext context) {
    ...
    print("new cat id ${widget.catId.toString()}");
    return Scaffold(
        appBar: getAppBar(getTranslated(context, 'SHOP_BY_SUBCAT')!, context),
  ...
  Future<void> uploadEstimate(File _image) async {
    ...
    //   "mobile": mobileController.text, //offset.toString(),
    //   "estimate": imagePath,
    //   //"category_id": widget.catId
    //   // DISCOUNT: disList[curDis].toString()
    // };
    ...
    var request = http.MultipartRequest('POST', Uri.parse(
        'https://alphawizztest.tk/plumbing_bazzar/app/v1/api/add_estimate'));
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: new ClipRRect(
                          // borderRadius: BorderRadius.circular(35.0),
                          child: commonHWImage(
                              "https://alphawizztest.tk/plumbing_bazzar/${subCatList[index].image.toString()}",
                              80.0,
                              120.0,
                              "",
                              context,
  ...
  Future<void> getFromGallery() async {
    ...
    // imagePath = File(result.toString()) ;
