...
final Uri getAllCatApi = Uri.parse(baseUrl + 'getallcategories');
final Uri getSubCatApi = Uri.parse(baseUrl + 'get_subcategories');
final Uri getMarqueeApi = Uri.parse(baseUrl + 'get_banner_images');
final Uri getVideoApi = Uri.parse(baseUrl + 'get_video');
final Uri getUserDetailsApi = Uri.parse(baseUrl + 'get_user_details');
final Uri updateUserApi = Uri.parse(baseUrl + 'update_user');
final Uri uploadEstimateApi = Uri.parse(baseUrl + 'add_estimate');
...
final Uri verifyLoginOtpApi = Uri.parse(baseUrl + 'verify_otp');
...
final Uri sendUserRequest = Uri.parse(baseUrl + 'user_send_request');
...
final Uri estimateListApi = Uri.parse(baseUrl + 'estimate_order_user');
...
const String UPLOAD_ESTIMATE = 'My Estimate';
const String CUSTOMER_NAME = 'Customer Name';
const String CUSTOMER_MOBILE = 'Customer Mobile';
const String SEND_LBL = 'Save Changes';

const String ESTIMATE_FILE = 'Estimate file';
...
const String PRODUCT = 'OUR PRODUCTS';
