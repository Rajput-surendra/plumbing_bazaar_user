...
extension colors on ColorScheme {
  ...
  static const Color secondary = Color(0xff01ADEF);
  ...
  static const Color grad1Color = Color(0xff01ADEF);
  static const Color grad2Color = Color(0xff01ADEF);
  static const Color lightWhite2 = Color(0xffEEF2F3);

  static const Color yellow = Color(0xfffdd901);

  static const Color red = Color(0xff01ADEF);
  //Color(0xffFF00FF);
